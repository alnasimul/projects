...
$resultComplete = mysqli_query($connection,$completeTasksQuery);
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>todo/tasks manager</title>
    <style>
        body {
            margin-top: 30px;
        }
        ...
        if(mysqli_num_rows($resultComplete) > 0){
            ...
            <table>
                ...
                <tbody>
                            ...
                            <td><input name="" class="label-inline" type="checkbox" value="<?php echo $cdata['id'];?>"></td>
                            <td><?php echo $cdata['id'];?></td>
                            <td><?php echo $cdata['task'];?></td>
                            <td><?php echo $cdate;?></td>
                             <td>
                                 <a class="delete" data-taskid="<?php echo $cdata['id'];?>" href='#'>Delete</a> |
